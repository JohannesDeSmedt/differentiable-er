...
from model_help import EventTransformer, SDFAProjector, entropic_relevance_diff_loss, entropic_relevance_loss
...
def evaluate_nap_model(model, le, sequences, max_len, er_loss, device):
    model.eval()
    total_loss = 0.0
    total_accuracy = 0.0
    total_precision = 0.0
